...
const SignupSection = () => {
  return (
    <section className="relative flex items-center justify-center w-full h-[75vh] bg-cover bg-center bg-no-repeat"
      style={{ 
        backgroundImage: "linear-gradient(180deg, rgba(0, 0, 0, 0.70) 0%, rgba(0, 0, 0, 0.30) 100%), url('/images/signup-bg.jpg')"
      }}>
      <div className="text-white max-w-screen-md px-4 text-center flex flex-col items-center">
        <h2 className="text-5xl font-bold mb-4 py-8 leading-[75px]">Reach your goals faster with expert mentors</h2>
