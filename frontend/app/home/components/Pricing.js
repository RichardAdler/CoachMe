      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center md:space-x-8 space-y-8 md:space-y-0">
          {plans.map((plan, index) => (
            <div key={index} className={`rounded-lg shadow-md p-6 w-full md:w-1/3 ${index === 1 ? 'bg-primary-color text-white transform scale-y-110' : 'bg-white'}`} style={{ backgroundColor: index === 1 ? 'rgba(91, 58, 199, 0.85)' : 'rgba(255, 255, 255, 0.85)' }}>
